    ...
    public class IdentityServiceTests
    {
        ...
        public async Task AddUserClaimAsync()
        {
            using (var context = new AdminIdentityDbContext(_dbContextOptions))
            {
                ...
                userClaimDto.Should().Be(newUserClaim);
            }
        }
        ...
        public async Task UpdateUserAsync()
        {
            using (var context = new AdminIdentityDbContext(_dbContextOptions))
            {
                ...
                //Assert updated user
                userDtoForUpdate.Should().Be(updatedUser);
            }
        }
        ...
        public async Task UpdateRoleAsync()
        {
            using (var context = new AdminIdentityDbContext(_dbContextOptions))
            {
                ...
                //Assert updated role
                roleDtoForUpdate.Should().Be(updatedRole);
            }
        }
        ...
        public async Task AddRoleClaimAsync()
        {
            using (var context = new AdminIdentityDbContext(_dbContextOptions))
            {
                ...
                //Assert new role
                roleClaimDto.Should().Be(newRoleClaimDto, options => options.Excluding(o => o.RoleName));
            }
        }
