...
namespace Skoruba.IdentityServer4.Admin.UnitTests.Controllers
{
    public class ConfigurationControllerTests
    {
        ...
        public async Task AddClient()
        {
            ...
            clientDto.Should().Be(adddedClient, opts => opts.Excluding(x => x.Id)
        ...
        public async Task AddClientClaim()
        {
            ...
            clientClaim.Should().Be(adddedClientClaim, opts => opts.Excluding(x => x.ClientClaimId)
        ...
        public async Task GetClientClaim()
        {
            ...
            viewModel.ClientClaims[0].Should().Be(clientClaimAdded);
        }
        ...
        public async Task AddClientSecret()
        {
            ...
            clientSecret.Should().Be(newClientSecret, opts => opts.Excluding(x => x.ClientSecretId)
        ...
        public async Task GetClientSecret()
        {
            ...
            viewModel.ClientSecrets[0].Should().Be(clientSecretAdded);
        }
        ...
        public async Task AddClientProperty()
        {
            ...
            clientProperty.Should().Be(newClientProperty, opts => opts.Excluding(x => x.ClientPropertyId)
        ...
        public async Task GetClientProperty()
        {
            ...
            viewModel.ClientProperties[0].Should().Be(clientPropertyAdded);
        }
        ...
        public async Task AddIdentityResource()
        {
            ...
            identityResourceDto.Should().Be(addedIdentityResource, opts => opts.Excluding(x => x.Id));
        }
        ...
        public async Task AddApiResource()
        {
            ...
            apiResourceDto.Should().Be(addedApiResource, opts => opts.Excluding(x => x.Id));
        }
        ...
        public async Task AddApiScope()
        {
            ...
            apiScopeDto.Should().Be(addedApiScope, opts => opts.Excluding(x => x.Id));
        }
        ...
        public async Task UpdateApiScope()
        {
            ...
            updatedApiScopeDto.Should().Be(addedApiScope, opts => opts.Excluding(x => x.Id));
        }
        ...
        public async Task AddApiSecret()
        {
            ...
            apiSecretsDto.Should().Be(addedApiScope, opts => opts.Excluding(x => x.ApiResourceId).Excluding(x => x.ApiResourceName).Excluding(x => x.ApiSecretId));
        }
